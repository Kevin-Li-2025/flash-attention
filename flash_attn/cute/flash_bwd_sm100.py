        ...
        while work_tile.is_valid_tile:
            ...
            if const_expr(not self.use_block_sparsity):
                ...
                (
                    ...
                    producer_state_Q_Qt=producer_state_Q_Qt,
                    producer_state_O_Ot=producer_state_O_Ot,
                    producer_state_LSE=producer_state_LSE,
                    producer_state_dPsum=producer_state_dPsum,
